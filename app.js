...
for(let i=0;i<message.mentions.users.size;i++){
  if(["343046183088029696"].includes(String(message.mentions.users.array()[i].id))){
    message.reply("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.reply("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.reply("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.reply("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.author.send("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.author.send("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.author.send("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
    message.author.send("Ах ты сцуко! Как ты смеешь майса пингать!? Я за такое обычно нахуй посылаю, но тебя просто много раз пингану!")
